...
| env-lantern-a | art/blender/environment/env-lantern-a/env-lantern-a.blend | public/assets/models/environment/env-lantern-a.glb | authored for this project via Blender MCP; ours | 0.340 × 2.440 × 0.340 m | 408 tris (396 vis + 12 col) / 4 materials (adds IronDark, LanternGlass emissive) / 0 textures | shipping | play.html — two placements flanking the dais at (±4.2, 0, 8.2); COL_post blocks walking through; SOCKET_flame reserved for the lighting director; glow carried by the authored emissive | design/reviews/env-lantern-a/ |
